...
from storage.models import IncidentCreate, IncidentResponse, ApprovalRequest, IncidentStatus
...
app = FastAPI(
    title="Log Monitor Ingestion API",
...
---
*This PR was automatically generated by Log Monitor AI. Please review carefully before merging.*
"""
...
async def health_check():
    ...
    return {
        ...
        "service": "log-monitor-ingestion-api",
...
async def ingest_v1_logs(payload: dict, background_tasks: BackgroundTasks):
    ...
    try:
        ...
        # Initialize OTLP parser
        parser = OTLPParser()
        
        # Parse OTLP payload into incidents
